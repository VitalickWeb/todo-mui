...
import {ErrorType} from "./tasks-redusers";
...
export const deleteTodListTC = (todoListID: string) => async (dispatch: Dispatch) => {
    dispatch(setStatusAC('loading'))
...
export const createTodListTC = (title: string) => async (dispatch: Dispatch) => {
    dispatch(setStatusAC('loading'))
